...
#     # Create a list to store pothole data as dictionaries
#     pothole_data_list = []
...
#             "X-coordinate": box[0],
#             "Y-coordinate": box[1],
#             "Confidence Score": score  # Change here
#         }
#         pothole_data_list.append(pothole_data)

#         cv2.rectangle(img, (box[0], box[1]), (box[0] + box[2], box[1] + box[3]),
#                     color=(0, 255, 0), thickness=2)
#         cv2.putText(img, "%" + str(round(score * 100, 2)) + " " + "PothHole", (box[0], box[1] - 10),
...
def detectPotholeonImage(image_filename):
    ...
    csv_filename = "pothole_data_image.csv"
